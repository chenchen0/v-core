<template>
    <div>
        <el-form
            ...
            :label-width="data.config.labelWidth | labelWidth"
        >
                ...
                <template v-if="item.type == 'grid'">
                    ...
                    >
                        <el-col
                            ...
                            :class="`widget-grid-content-${item.options.contentDirection} widget-grid-justify-${item.options.contentJustify}`"
                        >
            ...
            for (let i = 0; i < genList.length; i++) {
                if (genList[i].type === "grid") {
                    ...
                    if (Object.keys(this.value).indexOf(genList[i].model) >= 0) {
                        ...
                        if (["label", "button"].includes(genList[i].type)) {
                            continue;
                        }
