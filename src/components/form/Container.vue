<template>
    <el-container>
        ...
        <cus-dialog :visible="jsonVisible" @on-close="jsonVisible = false" ref="jsonPreview" width="800px" form>
            ...
            <ace-editor v-model="jsonTemplateStr" readonly lang="json" style="height: 400px" />
        ...
        <cus-dialog :visible="importJsonVisible" @on-close="importJsonVisible = false" ref="jsonPreview" width="800px" form>
            ...
            <ace-editor v-model="importJsonTemplate" lang="json" style="height: 400px" />
        ...
        <cus-dialog :visible="codeVisible" @on-close="codeVisible = false" ref="codePreview" width="800px" form :action="false">
            ...
            <ace-editor v-model="htmlTemplate" lang="html" readonly style="height: 500px" />
        </cus-dialog>
    </el-container>
</template>
...
const importJsonTemplate = JSON.stringify(
    {
        list: [
            {
                type: "input",
...
export default {
    ...
    methods: {
        ...
        setImportJson() {
            ...
            try {
                let json = JSON.parse(this.importJsonTemplate);

                console.log("获取json", json);
    ...
    computed: {
        importJsonTemplateStr() {
            return this.jsonStringify(this.importJsonTemplate);
        },
        jsonTemplateStr() {
            return this.jsonStringify(this.jsonTemplate);
        }
    },
    watch: {
        widgetForm: {
