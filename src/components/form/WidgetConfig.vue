<template>
    <div v-if="show">
        <el-form label-position="top">
            ...
            <el-form-item label="按钮选项" v-if="data.type == 'button'">
                <div>
                    <span>颜色：</span>
                    <el-select v-model="data.options.type">
                        <el-option v-for="item in ['default', 'primary', 'success', 'warning', 'danger', 'info']" :key="item" :value="item">
                        </el-option>
                    </el-select>
                </div>
                <div>
                ...
                <div>
                    <span>图标：</span>
                    <el-input style="width: 180px;" v-model.number="data.options.icon" placeholder="el-icon-iconName"></el-input>
                </div>
            </el-form-item>

            <el-form-item label="点击方法" v-if="data.type == 'button'">
                <el-input v-model="data.options.remoteFunc"> </el-input>
            </el-form-item>

            <el-form-item label="大小" v-if="Object.keys(data.options).indexOf('size') >= 0">
                宽度：<el-input style="width: 90px;" type="number" v-model.number="data.options.size.width"></el-input> 高度：<el-input
                    style="width: 90px;"
                    type="number"
            ...
            <template v-if="data.type == 'grid'">
                ...
                <el-form-item label="内容排列方向">
                    <el-radio-group v-model="data.options.contentDirection" size="mini">
                        <el-radio-button label="colunm">垂直</el-radio-button>
                        <el-radio-button label="row">水平</el-radio-button>
                    </el-radio-group>
                </el-form-item>

                <el-form-item label="内容水平排列" v-if="data.options.contentDirection == 'row'">
                    <el-select v-model="data.options.contentJustify">
                        <el-option value="start" label="左对齐"></el-option>
                        <el-option value="end" label="右对齐"></el-option>
                        <el-option value="center" label="居中"></el-option>
                        <el-option value="space-around" label="两侧间隔相等"></el-option>
            ...
            <template v-if="!['grid', 'button'].includes(data.type)">
                <el-form-item label="数据绑定Key">
                    <el-input v-model="data.model"></el-input>
                </el-form-item>
            </template>

            <template v-if="!['grid', 'label', 'button'].includes(data.type)">
